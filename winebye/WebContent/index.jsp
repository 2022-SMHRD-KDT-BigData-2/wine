	...
	<div id="page-wrapper">
		...
		<section id="header">
			...
			<div class="container">
				...
				<div id="banner">
		            <div id="banner2">
		                     <video autoplay="autoplay" muted="muted" loop='loop' height='700' >
				...
				<div class="row aln-center">
					<div class="col-4 col-12-medium">
						...
						<section class="sy">
							...
							<a href="http://www.wmuseum.co.kr/" class="feature-image"><img
								src="images/wine6.jpg" alt="" /></a>
							<p>
								<span style="font-weight:bolder">광양와인동굴</span><br>
					...
					<div class="col-4 col-6-medium col-12-small">
						...
						<section class="sy">
							...
							<ul class="quote-list">
								<li><img src="images/movie1.jpg" alt="" />
									<p>"1. 몬도비노"</p> <span>2004년작</span></li>
								<li><img src="images/movie2.jpg" alt="" />
									<p>"2. 사이드웨이즈"</p> <span>2004년작</span></li>
								<li><img src="images/movie3.jpg" alt="" />
									<p>"3. 와인미라클"</p> <span>2008년작</span></li>
							</ul>
						</section>
